...
--
-- Dumping events for database 'bd_10_teste'
--

--
-- Dumping routines for database 'bd_10_teste'
--
...
BEGIN
      ...
      IF(_id IS NULL) THEN
        ...
        SELECT * FROM bd_0.t101;

      ELSE

        SELECT *  FROM bd_0.t101 where c1_101 = _id;

      END IF;
      
      select * from bd_0.t103;
...
-- Dump completed on 2017-03-14  3:47:48
